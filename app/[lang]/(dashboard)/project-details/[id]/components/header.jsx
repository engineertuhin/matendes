...
const Header = () => {
  ...
  const navItems = [
    { title: "Project Details", link: `/project-details/${id}` },
    { title: "Employees", link: `/project-details/${id}/employee` },
    { title: "Income / Expense", link: `/project-details/${id}/income-expense` },
    { title: "Tool Assignments", link: `/project-details/${id}/tool-assignments` },
  ];
