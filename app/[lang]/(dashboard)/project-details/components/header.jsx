...
const Header = () => {
  ...
  const navItems = [
    ...
    { title: "Employees", link: "/project-details/employee" },
    { title: "Income / Expense", link: "/project-details/income-expense" },
    { title: "Tool Assignments", link: "/project-details/tool-assignments" },
  ];
